    ...
    <main class="inner-page case-studies">
        ...
        <section class="portfolio-filters">
            <ul id="filters" class="container text-upper filter-button-group dropdown">
                <li class="portfolio-filter-item is-checked dropdown-content"><a class="inner-filter"
                                                                                 href="javascript:void(0)"
                                                                                 title="All" data-filter="*"
                                                                                 class="active">All
                        projects</a></li>
				<?php
            ...
            <svg id="dropdown_svg" class="" xmlns="http://www.w3.org/2000/svg" width="21.65" height="8.44"
				...
				<?php while ( $the_query->have_posts() ) : $the_query->the_post();
                    ...
                    <div class="<?php echo $termsString; ?> all portfolio-item"> <?php // 'item' is used as an identifier (see Setp 5, line 6) ?>
                        ...
                        <figure class="grid-item-figure">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="178" height="204.97"
                                 viewBox="0 0 178 204.97">
                                <polygon
                                        points="176.5 152.86 89 203.24 1.5 152.86 1.5 52.11 89 1.73 176.5 52.11 176.5 152.86"
