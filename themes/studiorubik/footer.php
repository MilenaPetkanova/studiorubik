...
<footer class="site-footer inner-page__footer">
    ...
    <section class="site-footer__cta text-center text-upper">
        <a href="/contact-us">
            <p>
                <span>workwise</span>
                <span class="drop-a-line">drop<br>a line</span>
                <span>or otherwise</span>
            </p>
        </a>
    </section>
    ...
    <section class="site-footer__menu  container">
        ...
        <div class="site-footer__menu__list logo">
            <svg xmlns="http://www.w3.org/2000/svg" width="104.5168" height="115.5266" viewBox="0 0 104.5168 115.5266">
                ...
                <path
                        ...
                        fill="#f3f3f3"/>
                <path d="M46.134,107.3459v-1.4981h1.1177v1.4981Zm0,8.0088v-6.7559H47.24v6.7559Z" fill="#f3f3f3"/>
                <path
                ...
                <path
                        ...
                        fill="#f3f3f3"/>
                <path d="M73.884,107.3459v-1.4981h1.1177v1.4981Zm0,8.0088v-6.7559H74.99v6.7559Z" fill="#f3f3f3"/>
                <path
        ...
        <div class="site-footer__menu__list footer-newsletter">
            ...
            <form action="https://studiorubik.us10.list-manage.com/subscribe/post?u=fc572dc7ea88119dcbed69a6f&amp;id=33366115d9" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
            ...
            <div class="mc-field-group">
              ...
              <div id="mce-responses" class="clear">
                ...
                <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_fc572dc7ea88119dcbed69a6f_33366115d9" tabindex="-1" value=""></div>
...
<?php wp_footer(); ?>
<script>
         $('#mce-EMAIL').bind('mousedown.ui-disableSelection selectstart.ui-disableSelection', function(event) {
