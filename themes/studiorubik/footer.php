<!-- Back to top Arrow -->
<div class="back-to-top container cf">
    <a href="javascript:" id="return-to-top">
        <div data-aos="fade-up" class="back-to-top__hexagon">
            <svg xmlns="http://www.w3.org/2000/svg" width="28.8716" height="11.097" viewBox="0 0 28.8716 11.097"><title>
                    back-to-top</title>
