    ...
    <main class="inner-page portfolio-page-template">
        ...
        <section class="portfolio-filters">
            <ul id="filters" class="container text-upper filter-button-group">
				...
				$count = count( $terms );
				echo '<li class="portfolio-filter-item is-checked"><a class="inner-filte-r" href="javascript:void(0)" title="All" data-filter=".all" class="active">All projects</a></li>'; //default "All"
				if ( $count > 0 ) {
